...
- The **Fabric KQL MCP server**, when registered in the local Fabric MCP configuration, can be used as an alternative to `az rest` for agent-integrated query execution.
