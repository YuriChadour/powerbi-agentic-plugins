...
- **For semantic model authoring** (TMDL, refresh, permissions), cross-reference the [semantic-model-authoring](../../../powerbi/skills/semantic-model-authoring/SKILL.md) skill
- **For DAX query validation**, cross-reference the [semantic-model-authoring](../../../powerbi/skills/semantic-model-authoring/SKILL.md) skill for metadata discovery and DAX queries for validation.
