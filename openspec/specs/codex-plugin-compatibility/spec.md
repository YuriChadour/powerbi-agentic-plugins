# codex-plugin-compatibility Specification

## Purpose

Expose the repository's shared plugin catalog to Codex while preserving the existing Copilot and Claude source artifacts and behavior.
